...
------------------------------------------------------------------
-- GUI SETUP (ย่อขนาดและจัดเรียงให้ตรงกัน) - ใช้พื้นหลังสีดำ
------------------------------------------------------------------
...
MainFrame.Size = UDim2.new(0, 200, 0, 240)  -- ความสูงคงเดิม
MainFrame.Position = UDim2.new(0.5, 0, 0.5, 0)
MainFrame.AnchorPoint = Vector2.new(0.5, 0.5)
MainFrame.BackgroundColor3 = Color3.fromRGB(0, 0, 0)  -- เปลี่ยนเป็นสีดำ
MainFrame.BackgroundTransparency = 0  -- ไม่โปร่งใส
...
UIStroke.Color = Color3.fromRGB(50, 50, 50)  -- เส้นขอบสีเทาเข้ม
...
DragBar.BackgroundColor3 = Color3.fromRGB(20, 20, 20)  -- สีเทาเข้ม
DragBar.Active = true
...
Title.TextColor3 = Color3.fromRGB(200, 200, 200)  -- ตัวอักษรสีขาวนวล
...
MinimizeButton.Text = "-"
MinimizeButton.BackgroundColor3 = Color3.fromRGB(40, 40, 40)  -- ปุ่มสีเทาเข้ม
...
MiniButton.Text = "☰"
MiniButton.BackgroundColor3 = Color3.fromRGB(30, 30, 30)  -- ปุ่มสีเทาเข้ม
...
ToggleAutoLock.Size = UDim2.new(0, 160, 0, 24)
ToggleAutoLock.Position = UDim2.new(0, 20, 0, 30)
ToggleAutoLock.Text = "Auto-Lock: OFF"
ToggleAutoLock.BackgroundColor3 = Color3.fromRGB(40, 40, 40)  -- สีเทาเข้ม (ปิด)
...
ToggleAutoFire.Size = UDim2.new(0, 160, 0, 24)
ToggleAutoFire.Position = UDim2.new(0, 20, 0, 58)
ToggleAutoFire.Text = "Auto-Fire: OFF"
ToggleAutoFire.BackgroundColor3 = Color3.fromRGB(40, 40, 40)  -- สีเทาเข้ม (ปิด)
...
ToggleTeamCheck.Size = UDim2.new(0, 160, 0, 24)
ToggleTeamCheck.Position = UDim2.new(0, 20, 0, 86)
ToggleTeamCheck.Text = "Team Check: ON"
ToggleTeamCheck.BackgroundColor3 = Color3.fromRGB(0, 100, 0)  -- สีเขียว (เปิด)
...
ResetHitboxButton.Size = UDim2.new(0, 160, 0, 24)
ResetHitboxButton.Position = UDim2.new(0, 20, 0, 114)
ResetHitboxButton.Text = "Reset Hitboxes"
ResetHitboxButton.BackgroundColor3 = Color3.fromRGB(150, 0, 0)  -- สีแดง (Reset)
...
distanceLabel.Position = UDim2.new(0, 20, 0, 142)
...
distanceBox.Position = UDim2.new(0, 100, 0, 142)
...
headSizeLabel.Position = UDim2.new(0, 20, 0, 164)
...
headSizeBox.Position = UDim2.new(0, 100, 0, 164)
headSizeBox.Text = tostring(HEAD_HITBOX_SIZE)
...
bodySizeLabel.Position = UDim2.new(0, 20, 0, 186)
...
bodySizeBox.Position = UDim2.new(0, 100, 0, 186)
bodySizeBox.Text = tostring(BODY_HITBOX_SIZE)
...
label.Position = UDim2.new(0, 20, 0, 208)
label.Text = ""
...
local function moveCameraBehindTarget(target, zoomDistance)
    ...
    local camOffset = -forward * zoomDistance -- ใช้ zoomDistance แทนค่าเริ่มต้น 4
...
-- เพิ่มการควบคุมการซูมด้วย Scroll Wheel
...
RunService.RenderStepped:Connect(function()
    if autoLockEnabled then
        ...
        if newTarget ~= target then
            target = newTarget
            ZOOM_DISTANCE = 10  -- รีเซ็ตระยะซูมเมื่อเปลี่ยนเป้า
        end
        if target then
